                ...
                <div className={`px-4 w-full max-h-full overflow-y-hidden transition-all duration-500 ${isChatEmpty(chat) ? 'h-1/2' : 'h-full'}`}>
                    {isChatEmpty(chat) ? (
                        <div className={"w-full h-full flex flex-col justify-end items-center"}>
                            <h1 className="font-bold text-2xl sm:text-3xl lg:text-4xl text-center pb-2">Olá, bem vindo ao Chat Aç<span className="text-details-1">AI</span></h1>
                            <h2 className="lg:text-2xl text-center">Otimize queries em MySql e deixe o seu projeto mais eficiente com a nossa ferramenta!</h2>
                        </div>
                    ) : (
